...
import darkLogo from '../assets/images/darklogo.jpg'; // Adjust
      ...
      >
        <div className="aitheinfi-container w-[100%] max-w-[90rem] mx-auto px-2 md:px-[6rem] relative">
          <div className="overview-wrapper flex flex-col justify-start items-center mx-auto max-w-[55rem] ">
            ...
            <div ref={revealTextSectionRef} className="w-[100%] max-w-[768px]">
              <motion.div
              ...
              >
                ...
                >
                  ...
                  owns or controls Bitcoin and everyone can take part. Through
                  many of its unique properties, Bitcoin allows exciting uses
